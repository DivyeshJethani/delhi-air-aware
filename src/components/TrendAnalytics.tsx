...
export default function TrendAnalytics() {
  ...
  return (
    <section id="trends" className="py-24 bg-muted/30 border-t border-border">
      <div className="container mx-auto px-6">
        ...
        <div className="flex justify-center mb-8">
          <div className="flex gap-1 glass-card rounded-xl p-1 shadow-sm">
            {TABS.map((t, i) => (
              <button
                key={t}
                ...
                <AreaChart data={MONTHLY_DATA}>
                  <defs>
                    ...
                    <linearGradient id="pm25G" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%" stopColor="hsl(158 64% 36%)" stopOpacity={0.2} />
                  ...
                  <Area type="monotone" dataKey="aqi" name="AQI" stroke="hsl(199 80% 42%)" strokeWidth={2} fill="url(#aqiG)" />
                  <Area type="monotone" dataKey="pm25" name="PM2.5" stroke="hsl(158 64% 36%)" strokeWidth={2} fill="url(#pm25G)" />
                </AreaChart>
              </ResponsiveContainer>
              <div className="mt-4 p-3 rounded-xl border border-red-200 bg-red-50 flex items-start gap-2">
            ...
            <div className="glass-card rounded-2xl p-6 shadow-sm">
              ...
              <ResponsiveContainer width="100%" height={320}>
                <BarChart data={WEEKLY_DATA}>
                  ...
                  <Tooltip content={<CustomTooltip />} />
                  <Legend wrapperStyle={{ color: "hsl(var(--muted-foreground))", fontSize: 12 }} />
                  <Bar dataKey="morning" name="Morning (6–10AM)" fill="hsl(158 64% 36%)" radius={[4, 4, 0, 0]} />
                  <Bar dataKey="afternoon" name="Afternoon (12–4PM)" fill="hsl(199 80% 42%)" radius={[4, 4, 0, 0]} />
                  <Bar dataKey="evening" name="Evening (6–9PM)" fill="hsl(25 95% 48%)" radius={[4, 4, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
              <div className="mt-4 grid grid-cols-3 gap-3">
                ...
                <div className="bg-orange-50 border border-orange-200 rounded-xl p-3 text-center">
                  <p className="text-sm font-bold text-orange-500">Evening</p>
